...
backgroundImage: "url(" + bgv + ")"
    ...
    return (
      ...
      <div className="col-xs-3"><button className="Product__option des_btn none"  onClick={() => this.removeFakeCartItem(data.parentid)}><img className="trash_icn" src="/texture/dlt.png" /></button></div>
      </div>
    );
  }
}
